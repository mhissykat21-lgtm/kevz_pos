...
function bindEvents() {
  ...
  // Price per Piece is now entered manually — no auto-suggest/overwrite
  // from Original Price. (Previously this auto-filled a 20% markup, which
  // kept clobbering manually typed values.)
